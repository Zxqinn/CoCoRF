...
class Encoder(nn.Module):
    def __init__(self, input_size, hidden_size, output_size, dropout_p=0.5, cuda=True):
        ...
        # self.embed = nn.Embedding.from_pretrained(embed())  # Use pre-trained word vectors
...
class VAE(nn.Module):
    def __init__(self, vocab_size, hidden_size, emb_size, dropout=0, n_layers=1, cuda=True):
        super(VAE, self).__init__()
        self.encoder = Encoder(vocab_size, hidden_size, emb_size, dropout_p=dropout, cuda=cuda)
        self.decoder = Decoder(emb_size, hidden_size, vocab_size, n_layers=n_layers, dropout_p=dropout, cuda=cuda)
