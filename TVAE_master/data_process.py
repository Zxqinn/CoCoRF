...
with open('data/python/stackoverflow_queries.txt','r') as f:
    queries = f.readlines()
...
save_queries('data/python/query_corpus.txt', word_vocab)

with open('data/python/word_vocab.json','w') as f:
